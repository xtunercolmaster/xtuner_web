...
const DownloadSection = () => {
    return (
        <div className="flex flex-col lg:flex-row justify-center items-center w-full text-white p-8 min-h-screen bg-cover bg-no-repeat bg-gradient-custom" style={{ backgroundImage: `url(${backgroundDownload})` }}>
            {/* Text Section */}
            <div className="flex-1 flex flex-col justify-center items-center text-center lg:items-start lg:text-left lg:pl-[110px]">
                <h1 className="text-3xl md:text-3xl lg:text-4xl 2xl:text-5xl mb-4">Descarga Nuestra App!</h1>
            ...
            <div className="w-[200px] h-[200px] sm:w-[250px] sm:h-[250px] md:w-[300px] md:h-[300px] lg:w-[300px] lg:h-[300px] xl:w-[500px] xl:h-[500px] 2xl:w-[700px] 2xl:h-[700px] relative overflow-hidden mt-4 lg:mt-0">
                ...
                ></div>
                <img src={xtunerApp} alt="hero image" className="absolute object-cover w-full h-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10" />
            </div>
        </div>
    );
};
