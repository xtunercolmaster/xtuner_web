    ...
    return (
        <div className="flex flex-col w-full text-white p-8 bg-cover bg-no-repeat bg-dark-blue">
            ...
            <div className="flex flex-col 2xl:flex-row justify-center items-center w-full">
                ...
                {/* Image Section */}
                <div className="xl:ml-32 mb-8 2xl:mb-0 2xl:flex-1 flex justify-center items-center">
                    <div className="w-[200px] h-[200px] sm:w-[200px] sm:h-[200px] md:w-[300px] md:h-[300px] lg:w-[300px] lg:h-[300px] xl:w-[400px] xl:h-[400px] 2xl:w-[500px] 2xl:h-[500px] rounded-full overflow-hidden">
                ...
                <div className="flex-1 flex flex-col justify-center items-center text-center lg:items-start lg:text-left lg:pl-[110px]">
                    <h1 className="text-3xl md:text-4xl lg:text-4xl mb-8">Más acerca de los tuyos</h1>
