...
const Banner = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center w-full text-white p-8 min-h-screen bg-cover bg-no-repeat" style={{ backgroundImage: `url(${backgroundBanner})` }}>
      {/* Text Section */}
      <div className="flex-1 flex flex-col justify-center items-center text-center lg:items-start lg:text-left lg:pl-[110px] 3xl:pl-[120px]">
        ...
        <p className="mb-8 text-sm lg:text-base 2xl:text-lg max-w-md">
      ...
      {/* Image Section */}
      <div className="w-[200px] h-[200px] sm:w-[250px] sm:h-[250px] md:w-[300px] md:h-[300px] lg:w-[300px] lg:h-[300px] xl:w-[500px] xl:h-[500px] 2xl:w-[700px] 2xl:h-[700px] relative overflow-hidden mt-4 lg:mt-0 3xl:mr-22 4xl:mr-40">
        <div
