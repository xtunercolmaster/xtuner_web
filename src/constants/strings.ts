...
const strings = {
    ...
    cardContent3: "Acércate a los locutores de tus emisoras preferidas y sé parte de la programación. Interactúa en vivo, pide tu canción o mándales un mensaje directo desde la app.",
    ...
    aboutUsTittle3: "Creemos que la dedicación, el compromiso y la empatía son la fórmula del éxito",
    aboutUsContent3: "Trabajamos cada día para que conectar con quienes quieres sea fácil, justo y cercano. Escuchamos a nuestra comunidad y a las emisoras aliadas para construir una experiencia en la que todos —oyentes, locutores y anunciantes— tengan voz.",

    altAboutUs1: "two girls lauging looking at their phone",
    altAboutUs2: "five happy people raising their hands",
    altAboutUs3: "group of people working together",
